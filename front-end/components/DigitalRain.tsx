...
export default function DigitalRain() {
    ...
    useEffect(() => {
        ...
        const draw = () => {
            // Semi-transparent black to create fade effect - reduced transparency for better contrast
            ...
            for (let i = 0; i < drops.length; i++) {
                ...
                // Vary opacity for depth effect - increased opacity range for better contrast
